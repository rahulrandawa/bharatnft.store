...
function CreatePost() {
    ...
    console.log("AudioAAAAAAAAAAAAAAAAAAAAAAAAAAAAAimage", image.type)
    console.log("AudiopreviewImageimage", previewImage)
                                       ...
                                       (image.type == "video/mp4")?
                                        ...
                                        <source src={imageprev} type="video/mp4"/>
                                           ...
                                           (image.type == "audio/mpeg")?
                                            <audio   controls={true}>
                                            <source  src={audioPreviewImage} type="audio/mpeg"/>
                                            </audio>
                                            :
                                 ...
                                 <Col lg={3} md={3}>
                                    ...
                                    <div className='card p-4 mt-3 text-center' style={{ border: "2px dashed" }}>
                                        <div className="card-body customCardBody">
                                            ...
                                            <div className="my-4"><small>JPG, PNG, GIF, SVG <br></br> Up to 250MB</small></div>
                        ...
                        <Col lg={6}>
                            <div className='form-section'>
                                ...
                                <Form.Group className="mb-3" controlId="formBasicEmail">
                                    ...
                                    {/* <Form.Select aria-label="Floating label select example" onChange={(e) => setChain(e.target.value)} disabled> */}
